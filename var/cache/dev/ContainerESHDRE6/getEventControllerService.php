...
class getEventControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.V_WBGZv'] ?? $container->load('get_ServiceLocator_VWBGZvService'))->withContext('App\\Controller\\EventController', $container));
